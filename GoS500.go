...
func main() {
	...
	/*ATC2603C*/
	fmt.Println("Ver:", Device.IATC2603C().Version())
	fmt.Println("Temperature:", Device.IATC2603C().Temperature(), "C")
	fmt.Println("SYSPWR:", Device.IATC2603C().VoltageMV(Device.V_SYSPWR), "mV")
